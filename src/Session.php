...
final class Session {
    ...
    public function __construct(private string $sessionId, private ?string $username = null, ?string $csrfToken = null) {
        ...
        $this->http = new HttpClient($headers, $cookie);
    }
    ...
    public function user(string $username): User { return new User($username, $this); }
    public function project(int|string $id): Project { return new Project((string)$id, $this); }
    public function studio(int|string $id): Studio { return new Studio((string)$id, $this); }
