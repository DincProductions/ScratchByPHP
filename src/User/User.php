...
final class User {
    public function __construct(private string $username, private ?Session $session=null){}
    private function http():HttpClient{return $this->session?->http()??new HttpClient(['Accept'=>'application/json']);}
    ...
    public function get():array{return $this->http()->get('https://api.scratch.mit.edu/users/'.rawurlencode($this->username))->json();}
